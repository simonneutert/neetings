...
!function (t, e) {
			...
			if (
				...
				(t = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing")
					.filter((t) => t !== this._element).map((t) =>
						Rt.getOrCreateInstance(t, { toggle: !1 })
	...
	const He = {
		...
		effect: function (t) {
			...
			null != n &&
				...
				ke(e.elements.popper, n) && (e.elements.arrow = n);
		},
	...
	function ze(t) {
		...
		if (c) {
			...
			A === me(i) && "static" !== Le(A = De(i)).position && "absolute" === a &&
		...
		var i = e,
			...
			w = function (t, e, i, n) {
				var s = "clippingParents" === e
						? function (t) {
							var e = ti($e(t)),
								i = ["absolute", "fixed"].indexOf(Le(t).position) >= 0 && _e(t)
									? Ne(t)
									: t;
							return ge(i)
								? e.filter(function (t) {
	...
	class Ki extends W {
		constructor(t, e) {
			super(t, e),
				...
				this._menu = z.next(this._element, Mi)[0] ||
					z.prev(this._element, Mi)[0] || z.findOne(Mi, this._parent),
		...
		static dataApiKeydownHandler(t) {
			...
			const s = this.matches(Pi)
					? this
					: z.prev(this, Pi)[0] || z.next(this, Pi)[0] ||
	...
	class kn extends W {
		...
		_triggerBackdropTransition() {
			...
			"hidden" === e || this._element.classList.contains(Cn) ||
				...
				if ("click" === e) {
					...
					N.on(this._element, t, this._config.selector, (t) => {
						...
						N.on(this._element, i, this._config.selector, (t) => {
							const e = this._initializeOnDelegatedTarget(t);
							e._activeTrigger["focusout" === t.type ? ls : as] = e._element
	...
	const Ls = ".bs.tab",
		...
		Us =
			`.${Rs}[data-bs-toggle="tab"], .${Rs}[data-bs-toggle="pill"], .${Rs}[data-bs-toggle="list"]`;
	class Gs extends W {
		constructor(t) {
			super(t),
